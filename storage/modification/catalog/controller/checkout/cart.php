...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			$config_show_onepcheckout = $this->config->get('config_show_onepcheckout');
			if ($config_show_onepcheckout == '1') {
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['show_onepcheckout'] = $this->config->get('config_show_onepcheckout');
				$this->load->model('tool/image');
