...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
			...
			$this->document->addStyle('view/stylesheet/cyberstore/mob_d.css');
			$data['help_mob_device'] = $this->language->get('help_mob_device');
			$data['text_mob_device'] = $this->language->get('text_mob_device');
			$data['help_tablet_device'] = $this->language->get('help_tablet_device');
			$data['text_tablet_device'] = $this->language->get('text_tablet_device');
			$data['help_pc_device'] = $this->language->get('help_pc_device');
			$data['text_pc_device'] = $this->language->get('text_pc_device');
		...
		foreach ($layout_modules as $layout_module) {
			...
			'mob_device'   => $layout_module['mob_device'] ? $layout_module['mob_device'] : 0,
			'tablet_device'   => $layout_module['tablet_device'] ? $layout_module['tablet_device'] : 0,
			'pc_device'   => $layout_module['pc_device'] ? $layout_module['pc_device'] : 0,
