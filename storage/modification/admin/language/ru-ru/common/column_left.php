...
// Text
				...
				$_['text_cyber_news'] = 'Новости';
				$_['text_cyber_news_category'] = 'Категории';
				$_['text_cyber_news_articles'] = 'Статьи';
				$_['text_cyber_news_settings'] = 'Настройки';
				$_['text_cyber_news_review'] = 'Отзывы';
...
$_['text_captcha']                     = 'Капча';
		...
		$_['text_add_demo'] = 'Быстрый старт';
        $_['text_cyberstore_theme'] = 'Настройка шаблона';
        $_['text_cyberstore_menu'] = 'CyberStore';
