      ...
      <div class="tab-content form-horizontal">
		...
		<div class="tab-pane" id="tab-about">
			<table class="form about">
				...
				<tr>
					<td>Contact</td>
					<td><a href="mailto:soloha.i.v@gmail.com">soloha.i.v@gmail.com</a></td>
				</tr>
				<tr>
					<td>Links</td>
					<td>
						...
						<b>Module page :</b> <a target="new" href="https://bySoloha.com/">Pro Email Template</a><br/>
						<b>Other modules :</b> <a target="new" href="https://bySoloha.com/">My modules on opencart</a><br/>
					</td>
				</tr>
			</table>
		</div>
