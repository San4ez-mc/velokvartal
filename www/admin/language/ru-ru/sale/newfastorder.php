...
$_['heading_title_fastorder']   								= 'Быстрый заказ - Активация ';
// Text
...
$_['text_comment_buyer']   	 									= 'Покупателя';
...
$_['entry_icon_send_fastorder'] 								= 'Иконка на кнопке Оформить заявку:';
$_['entry_background_button_send_fastorder'] 					= 'Цвет кнопки Оформить заявку:';
$_['entry_background_button_send_fastorder_hover'] 				= 'Цвет кнопки Оформить заявку при наведении:';
$_['entry_background_button_open_form_send_order'] 				= 'Цвет кнопки быстрый заказ:';
$_['entry_icon_open_form_send_order'] 							= 'Иконка кнопки быстрый заказ:';
$_['entry_color_button_open_form_send_order'] 					= 'Цвет иконки и текста:';
$_['entry_text_open_form_send_order'] 							= 'Название кнопки быстрый заказ';
$_['entry_any_text_at_the_bottom'] 								= 'Добавить любой текст после кнопки оформить заявку:';
$_['entry_img_fastorder'] 										= 'Добавить Картинку в быстрый заказ:';
$_['entry_any_text_at_the_bottom_color'] 						= 'Цвет текста после кнопки оформить заказ:';
$_['entry_background_button_open_form_send_order_hover'] 		= 'Цвет кнопки быстрый заказ при наведении:';
$_['entry_mask_phone_number'] 									= 'Маска телефона(999-999-99-99)';
...
$_['text_before_button_send'] 									= 'Любой Текст перед кнопкой оформить заказ';
$_['text_complete_quickorder'] 									= 'Текст после успешного оформления заказа!';

$_['text_setting_module'] 										= 'Настройки модуля';
...
$_['entry_you_email_quickorder'] 								= 'Email на который будет приходить уведомление о заказе';
