<?php
// Heading
$_['heading_title']                       			= '<span style="color:#43b02a;">Cyber</span>Store -  Вопрос - ответ';
...
$_['column_comment_buyer']							= 'Вопрос';

// Tabs
$_['tab_form_field']                         		= 'Поля Формы';
$_['tab_list']                            			= 'Список вопросов';
...
$_['column_comment_manager']                   	  	= 'Ответ Администратора';
...
$_['success_add_comment']                    		= 'Вы успешно добавили Комментарий!';
...
$_['error_email_question_answer']     				= 'Укажите свой Email! Это поле обязательно для заполнения';
