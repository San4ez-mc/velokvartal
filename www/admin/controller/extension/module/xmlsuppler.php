<?php
class ControllerExtensionModuleXmlsuppler extends Controller {
    public function index() {

        // Загружаем "модель" модуля
        $this->load->model('extension/module/xmlsuppler');
        ...
        $data += $this->load->language('extension/module/xmlsuppler');
        // Загружаем "хлебные крошки"
        $data += $this->GetBreadCrumbs();

        // Кнопки действий
        $data['action'] = $this->url->link('extension/module/xmlsuppler', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/module/xmlsuppler', $data));
    ...
    private function GetBreadCrumbs() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/xmlsuppler', 'user_token=' . $this->session->data['user_token'], true)
        );
        return $data;
    }
