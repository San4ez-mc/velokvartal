...
class ControllerExtensionTotalSet extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['total_set_sort_order'])) {
            $data['total_set_sort_order'] = $this->request->post['total_set_sort_order'];
        } else {
            $data['total_set_sort_order'] = $this->config->get('total_set_sort_order');
        }
